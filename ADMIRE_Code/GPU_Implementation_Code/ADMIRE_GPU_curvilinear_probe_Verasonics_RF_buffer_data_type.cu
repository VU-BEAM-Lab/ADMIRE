...
// Description of ADMIRE_GPU_curvilinear_probe_Verasonics_RF_buffer_data_type.cu: 
...
if (!initialized) {
   ...
   scan_conversion_parameters_length = (int)GPU_fixed_params_h[18];
   scan_converted_num_axial_positions = (int)GPU_fixed_params_h[19];
   scan_converted_num_lateral_positions = (int)GPU_fixed_params_h[20];
   channel_data_output_flag = (int)GPU_fixed_params_h[21];
...
int16 * data_h;
data_h = (int16*)mxGetData(prhs[21]);
