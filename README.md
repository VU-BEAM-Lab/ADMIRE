...
```params.lambda_scaling_factor```: The scaling factor that is used in the calculation of lambda, which is used in elastic-net regularization. This is the same as ![clambda](https://latex.codecogs.com/svg.latex?c_%7B%5Clambda%7D).
