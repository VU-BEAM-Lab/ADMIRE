...
Once we have the parameters provided by the ```ADMIRE_curvilinear_probe_verasonics_parameters_calculation.m``` script, we will open up the ```ADMIRE_models_generation_main.m``` script.
